...
def convert_enum(obj):
    ...
    constructor, variables = get_constructor_and_variables(old_enum_object.get('syntax', {}), reference_mapping)
    ...
    fields = list(filter(lambda x: x.get('type') == 'attribute', children_objects))
